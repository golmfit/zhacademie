        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="flex flex-col space-y-4">
              <Link href="/marketing" className="text-gray-700 font-medium px-3 py-2 hover:text-primary">
                Home
              </Link>
              <Link href="/marketing/about" className="text-gray-700 font-medium px-3 py-2 hover:text-primary">
                About
              </Link>
              <Link href="/marketing/blog" className="text-gray-700 font-medium px-3 py-2 hover:text-primary">
                Blog
              </Link>
              <Link href="/marketing/contact" className="text-gray-700 font-medium px-3 py-2 hover:text-primary">
                Contact
              </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {/* Social media icons with improved mobile touch targets */}
              <a
